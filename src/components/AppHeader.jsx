...
const AppHeader = ({onPress, title}) => {
  return (
    <View style={{flexDirection: 'row', gap: title ? 10 : 0, marginTop: title ? responsiveHeight(1) : 0, justifyContent: title ? 'flex-start' : 'space-between', alignItems: 'center', paddingVertical: responsiveHeight(2), paddingHorizontal: responsiveHeight(2)}}>
